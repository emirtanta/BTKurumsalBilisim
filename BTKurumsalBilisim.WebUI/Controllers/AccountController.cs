...
namespace BTKurumsalBilisim.WebUI.Controllers
{
    public class AccountController : Controller
    {
        ...
        private SignInManager<User> _signInManager;//cookie işlemleri için tanımladım
        ...
        public async Task<IActionResult> Register(RegisterModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                await _emailSender.SendEmailAsync(model.Email, "Hesabınızı Onaylayınız", $"Lütfen email hesabınızı onaylamak için linke <a href='https://localhost:44390{url}'>tıklayınız</a>");
        ...
        public async Task<IActionResult> ForgotPassword(string Email)
        {
            ...
            await _emailSender.SendEmailAsync(Email, "Reset Password", $"linke tıklayın <a href='https://localhost:44390{url}'>tıklayınız</a>");
